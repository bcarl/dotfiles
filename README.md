...
I shall call them dotfiles and they shall be mine.
...
```sh
git clone https://github.com/bcarl/dotfiles.git ~/.dotfiles
cd ~/.dotfiles
script/bootstrap
```
...
Thanks to [holman](https://github.com/holman)'s wonderful
